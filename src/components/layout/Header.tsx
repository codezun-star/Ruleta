    ...
    <header className="sticky z-50 border-b-2 border-ink bg-paper-2" style={{top: 'env(safe-area-inset-top, 0px)'}}>
      <div className="mx-auto flex h-14 w-full max-w-6xl items-center gap-4 px-5">
        ...
        <nav aria-label={t('how')} className="ml-auto hidden items-center gap-5 md:flex">
          <a href="#modos" className="text-xs font-bold tracking-[0.12em] text-ink-2 uppercase hover:text-vermilion-2">
            {t('raffle')}
          </a>
          <a href="#como-funciona" className="text-xs font-bold tracking-[0.12em] text-ink-2 uppercase hover:text-vermilion-2">
            {t('how')}
          </a>
        </nav>
